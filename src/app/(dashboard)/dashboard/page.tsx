        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">UGX 25,000</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">UGX 15,000</p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <p className="text-sm font-medium text-gray-900">Monthly Savings</p>
                  <p className="text-sm text-gray-500">Jan 15, 2024</p>
                </div>
              </div>
              <span className="text-sm font-semibold text-green-600">+UGX 5,000</span>
            </div>
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <p className="text-sm font-medium text-gray-900">Loan Repayment</p>
                  <p className="text-sm text-gray-500">Jan 12, 2024</p>
                </div>
              </div>
              <span className="text-sm font-semibold text-blue-600">UGX 2,500</span>
            </div>
            ...
            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <p className="text-sm font-medium text-gray-900">Group Contribution</p>
                  <p className="text-sm text-gray-500">Jan 10, 2024</p>
                </div>
              </div>
              <span className="text-sm font-semibold text-purple-600">UGX 1,000</span>
            </div>
          </div>
        </div>
